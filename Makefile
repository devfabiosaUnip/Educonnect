...
INCLUDES = -Isrc -Isrc/admin -Isrc/storage -Isrc/utils -Isrc/server_logic -Isrc/professor -Isrc/student
LIBS = -lws2_32
...
$(TARGET_SERVER): $(OBJS_SERVER)
	$(CC) $(CFLAGS) $(INCLUDES) $(OBJS_SERVER) -o $@ $(LIBS)

$(TARGET_CLIENT): $(OBJS_CLIENT)
	$(CC) $(CFLAGS) $(INCLUDES) $(OBJS_CLIENT) -o $@ $(LIBS)
